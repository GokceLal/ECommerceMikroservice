...
import static com.example.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> elasticServiceExceptionHandler(ElasticServiceException authServiceException){
